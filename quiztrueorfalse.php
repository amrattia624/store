...
$table=$subject."_".$section."_question_trueorfalse";
?>
<!DOCTYPE HTML>
<html>
  <head>
            ...
            <div class="question-user2">
                <h2><span id="q" class="ng-binding"> س </span><i class="fas fa-question-circle" style="font-size: 20px;"></i>
                    ...
                    <form method="POST" action="" id="form">
                        ...
                        <h3><?php echo '<span style="color:#f00;"> (<span style="color:#080;">'.@$row["title"].'</span>) من درس </span><br>';?><?php echo @$row["trueorfalse_question"];?></h3>
                            <div class="question-user2-child">
                                ...
                                <div class="options-parent" id="options-parent1"><input required type="radio" name="userans" value="صح"/><i class="fas fa-check"></i></div>
                                <div class="options-parent" id="options-parent2"><input required type="radio" name="userans" value="خطأ"/><i class="fas fa-times"></i></div>
                            </div>
                    ...
                    if($_SESSION['clicks']>5){ 
                        $result3 =$r->query ("SELECT `trueorfalseicon`, `userans` FROM $table;");
                        $storeArray = Array();
                        while ($row3 = mysqli_fetch_array($result3, MYSQLI_ASSOC)) {
                        if($row3['trueorfalseicon']==$row3['userans']){
                        @$_SESSION['score'] += 1 ;
	                     }
                         }
