...
<?php
        if(isset($_GET["id"]))
        {
            ...
            while($row=mysqli_fetch_assoc($query)){
              echo'<iframe src="teacherscontrol/vid/'.$row["vedioex"].'" style="top: 0; left: 0;  bottom: 0;  right: 0;width: 100%;   height: 50%;border: none;"> 
              </iframe>';
              echo'<iframe src="teacherscontrol/pdffile/'.$row["pdffile"].'" style="top: 0; left: 0;  bottom: 0;  right: 0;width: 100%; height: 50%;border: none;"> 
              </iframe>';
            }
        }else
        {
